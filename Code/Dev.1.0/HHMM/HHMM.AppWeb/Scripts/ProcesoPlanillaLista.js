...
window.onload = function () {
    ...
    if (matrizSeguridad.length > 0) {
        if (((matrizSeguridad[0].split("¦")[2] * 1) != 1)) {
            ...
            document.getElementById("btnRevertirObligacionPagado").parentNode.style.display = "none";
            removeSeguridad("btnRevertirObligacionPagado");
        }
...
function configurarControles() {
    ...
    btnBuscarDetalleOA.onclick = function () {
        ...
        if (txtOADetalle != "") {
            ...
            divIfrDetalleOA.src = urlBase + "Mantenimiento/OADetalleLista/?ss=" + ss + "&su=" + intSucursalId + "&oa=" + sanitizeHTML(txtOADetalle);
        }
    }
...
function buscarProvision(id, idCompania) {
